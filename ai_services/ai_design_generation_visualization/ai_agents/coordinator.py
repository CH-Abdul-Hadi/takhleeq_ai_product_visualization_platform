...
async def _apply_design_with_pollinations(
    *,
    ...
    """Blend the design onto the real product image using alpha compositing."""
    # We use the design_image_b64 already generated by the Agent.
    # No need to generate a second, different design from Pollinations here.
